...
export const FAPTEKA_REPORTS: Record<FaptekaReportKey, FaptekaReport> = {
  ...
  salesTotals: {
    ...
    fields: [
      { key: "F", meaning: "Filial ID", erpField: "Branch mapping / filter" },
      { key: "D", meaning: "Sana", erpField: "Sale.createdAt" },
      { key: "DT", meaning: "Hujjat turi: 2,4 chakana; 7 sug'urta; 3,8 qaytarish", erpField: "Filtr" },
      { key: "SP", meaning: "Summa (PRICE1 bo'yicha)", erpField: "Tekshirish uchun" },
      { key: "SS", meaning: "Sotuv summasi (PRICE bo'yicha)", erpField: "Tekshirish uchun" },
      { key: "SI", meaning: "Tan narx summasi (INCOMELN.PRICESKID)", erpField: "SaleItem.costPrice" },
    ],
  },
  incomingTotals: {
    key: "incomingTotals",
    id: 20,
    title: "Prihody — hujjat kesimida (F-Apteka kodida TOP 1 cheklovi bor)",
    direction: "F_APTEKA_TO_ERP",
